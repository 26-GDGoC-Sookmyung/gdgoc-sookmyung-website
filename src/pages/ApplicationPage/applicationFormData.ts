...
export const applicationFormSteps: ApplicationFormStep[] = [
  ...
  },
  {
    ...
    questions: [
      ...
      {
        id: 'expectation',
        label: 'GDGoC Sookmyung 활동을 통해 얻어가고자 하는 것은 무엇인가요?',
        type: 'textarea',
        required: true,
        placeholder:
  ...
  },
  {
    ...
    questions: [
      ...
      {
        id: 'projectRole',
        label: '본인이 진행한 프로젝트와 그 안에서의 역할에 대해 이야기해 주세요.',
        type: 'textarea',
        required: true,
        placeholder:
    ...
    questions: [
      {
        ...
        required: true,
        options: [
          { id: '0828-12', label: '08/28 (금) 오후 12시 ~ 1시' },
          { id: '0828-13', label: '08/28 (금) 오후 1시 ~ 2시' },
          { id: '0828-14', label: '08/28 (금) 오후 2시 ~ 3시' },
          { id: '0828-15', label: '08/28 (금) 오후 3시 ~ 4시' },
          { id: '0829-12', label: '08/29 (토) 오후 12시 ~ 1시' },
          { id: '0829-13', label: '08/29 (토) 오후 1시 ~ 2시' },
          { id: '0829-14', label: '08/29 (토) 오후 2시 ~ 3시' },
          { id: '0829-15', label: '08/29 (토) 오후 3시 ~ 4시' },
          { id: '0830-18', label: '08/30 (일) 오후 6시 ~ 7시' },
          { id: '0830-19', label: '08/30 (일) 오후 7시 ~ 8시' },
          { id: '0830-20', label: '08/30 (일) 오후 8시 ~ 9시' },
          { id: '0831-17', label: '08/31 (월) 오후 5시 ~ 6시' },
          { id: '0831-18', label: '08/31 (월) 오후 6시 ~ 7시' },
          { id: '0831-19', label: '08/31 (월) 오후 7시 ~ 8시' },
          { id: '0831-20', label: '08/31 (월) 오후 8시 ~ 9시' },
          { id: '0901-18', label: '09/01 (화) 오후 6시 ~ 7시' },
          { id: '0901-19', label: '09/01 (화) 오후 7시 ~ 8시' },
          { id: '0901-20', label: '09/01 (화) 오후 8시 ~ 9시' },
          { id: '0902-17', label: '09/02 (수) 오후 5시 ~ 6시' },
          { id: '0902-18', label: '09/02 (수) 오후 6시 ~ 7시' },
          { id: '0902-19', label: '09/02 (수) 오후 7시 ~ 8시' },
          { id: '0902-20', label: '09/02 (수) 오후 8시 ~ 9시' },
        ],
      },
      {
        id: 'participation',
  ...
  questions: [
    {
      ...
      required: true,
      options: [
        { id: '0821-09', label: '08/21 (금) 오전 9시 ~ 10시' },
        { id: '0821-10', label: '08/21 (금) 오전 10시 ~ 11시' },
        { id: '0821-11', label: '08/21 (금) 오전 11시 ~ 오후 12시' },
        { id: '0821-12', label: '08/21 (금) 오후 12시 ~ 오후 1시' },
        { id: '0821-13', label: '08/21 (금) 오후 1시 ~ 오후 2시' },
        { id: '0821-14', label: '08/21 (금) 오후 2시 ~ 오후 3시' },
        { id: '0821-15', label: '08/21 (금) 오후 3시 ~ 오후 4시' },
        { id: '0821-16', label: '08/21 (금) 오후 4시 ~ 오후 5시' },
      ],
    },
    {
      id: 'participation',
...
export function getApplicationFormSteps(applicationType: ApplicationRouteSlug) {
  if (applicationType === 'team-member') {
    return applicationFormSteps.map((step) =>
      step.id === 'interview' ? teamMemberInterviewStep : step,
    );
  }
